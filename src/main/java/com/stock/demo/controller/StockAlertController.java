...
public class StockAlertController {
	...
	public JSONObject getStockInfo(HttpServletResponse response,
	...
	public StockInfo getStockInfoObj(HttpServletResponse response,
			@RequestParam("symbol") String symbol,
			@RequestParam(value="series",required = false) String series) {
	...
	public String getPrice(HttpServletResponse response,
			@RequestParam("symbol") String symbol,
			@RequestParam(value="series",required = false) String series) {
